...
"bookshelf" : "../../../bac/English/ebooks", // Relative path from this preset file to the bookshelf directory. "/" at the end is ignored. (To use a path begins with "http(s)://", read <01> at the bottom of this preset file.)
...
/* !!!! BE CAREFUL !!!! */ "trustworthy-origins" : ["https://padlet-uploads.storage.googleapis.com","https://github.com/","https://raw.githubusercontent.com/"], // origins you trust other than where this Bibi is installed. (blank is recommended).
